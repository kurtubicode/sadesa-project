...
export default function StaffPengaduan({ pengaduan, filters }: Props) {
    const [search, setSearch] = useState(filters.search ?? '');

    const applyFilter = (extra: Record<string, string>) =>
        router.get('/staff/pengaduan', { ...filters, ...extra }, { preserveState: true });
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-6 p-4">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">Total {pengaduan.total} pengaduan</p>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    >
                        <option value="">Perlu Ditangani</option>
                    ...
                    {(filters.status || filters.search) && (
                        <button
                            onClick={() => router.get('/staff/pengaduan')}
                    ...
                    {pengaduan.last_page > 1 && (
                        <div className="flex items-center justify-between border-t px-4 py-3">
                            <p className="text-sm text-muted-foreground">
                                Halaman {pengaduan.current_page} dari {pengaduan.last_page}
                            </p>

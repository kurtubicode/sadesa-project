...
export default function KepalaPengajuan({ pengajuan, filters }: Props) {
    const [search, setSearch] = useState(filters.search ?? '');

    const applyFilter = (extra: Record<string, string>) =>
        router.get('/kepala-desa/pengajuan', { ...filters, ...extra }, { preserveState: true });
            ...
            <div className="flex flex-col gap-6 p-4">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    {(filters.status || filters.search) && (
                        <button
                            onClick={() => router.get('/kepala-desa/pengajuan')}
